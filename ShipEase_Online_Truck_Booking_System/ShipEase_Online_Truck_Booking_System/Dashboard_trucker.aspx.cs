...
{
    public partial class Dashboard_for_truckers : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (rd.HasRows)
            {
                ...
                Session["bidder_uid"] = rd["uid"].ToString(); //store uid in session from login_DB
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (row != null)
            {
                ...
                Session["shpmnt_UID"] = id;
                Response.Redirect("display_selection.aspx");
            }
        }
    }
}