...
{
    public partial class trucker_history : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            String bidder_uid = Session["bidder_uid"].ToString();

            //show data in Gridview
            cmd = new SqlCommand("Select * from shipment_list where bidder_uid=@bidder_uid AND date BETWEEN @start_dt AND @end_dt;", con);
            ...
            //total price 
            cmd1 = new SqlCommand("Select SUM(price) from shipment_list where bidder_uid=@bidder_uid AND date BETWEEN @start_dt AND @end_dt;", con);
            cmd1.Parameters.AddWithValue("@bidder_uid", bidder_uid);
